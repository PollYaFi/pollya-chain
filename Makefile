...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=pollya \
		  -X github.com/cosmos/cosmos-sdk/version.AppName=pollyad \
		  -X github.com/cosmos/cosmos-sdk/version.Version=$(VERSION) \
		  -X github.com/cosmos/cosmos-sdk/version.Commit=$(COMMIT) \
		  -X github.com/CosmWasm/wasmd/app.Bech32Prefix=poll \
...
ifeq ($(OS),Windows_NT)
	...
	go build -mod=readonly $(BUILD_FLAGS) -o build/pollyad ./cmd/wasmd
endif

build-windows-client: go.sum
	GOOS=windows GOARCH=amd64 go build -mod=readonly $(BUILD_FLAGS) -o build/pollyad.exe ./cmd/wasmd
